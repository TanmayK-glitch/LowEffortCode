import defaultHeroImage from './assets/hero-image.jpg';

const Hero = ({
    title = "INTELLIGENCE",
    titleSuffix = "ARCHITECTED.",
    subtitle = "We build the cognitive infrastructure for the next generation of enterprise. Precision, scalability, and absolute control.",
    eyebrow = "Strategic AI Partners",
    ...
    return (
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-[#0a0a0a] text-white overflow-hidden font-sans">
            {/* Left Column: Content */}
            <div className="flex flex-col justify-center px-6 py-12 lg:px-16 xl:px-24 border-r border-white/5 order-2 lg:order-1 relative z-10">
                <div className="max-w-xl">
                    ...
                    <h1 className="text-5xl lg:text-7xl font-headline font-extrabold tracking-[-0.02em] leading-[0.9] text-white mb-8 overflow-hidden">
                        <span className="hero-headline block">{title}</span>
                        <span className="hero-headline block text-gray-400">{titleSuffix}</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <button
                            onClick={onCtaClick}
                            className="hero-btn bg-white text-black px-8 py-4 font-bold text-xs uppercase tracking-wider hover:bg-gray-200 transition-colors duration-200 border border-white font-mono"
                        >
                            {ctaText}
                        </button>
                        <button
                            onClick={onSecondaryCtaClick}
                            className="hero-btn bg-transparent border border-gray-700 text-gray-300 px-8 py-4 font-bold text-xs uppercase tracking-wider hover:border-white hover:text-white transition-colors duration-200 font-mono"
                        >
                            {secondaryCtaText}
                        </button>
                    </div>
