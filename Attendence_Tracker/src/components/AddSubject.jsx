        ...
        return (
            ...
            >
                ...
                <div className="text-center">
                    <h2 className="text-xl font-bold text-neutral-300">Add New Subject</h2>
                    <p className="text-sm text-neutral-500">Track a new course</p>
                </div>
            </button>
        );
    }
    ...
    return (
        <div className="w-full bg-[#111] border border-white/10 rounded-3xl p-8 animate-in fade-in zoom-in-95 duration-300 relative overflow-hidden shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                    type="submit"
                    className="w-full py-4 bg-emerald-500 text-black rounded-xl font-bold text-lg shadow-lg mt-2"
                >
                    Create Subject
                </button>
            </form>
